...
|:---:|:---:|
| ![Gini](charts/project1/gini_coefficient_timeseries.png) | ![Inflation](charts/project1/inflation_rate_comparison.png) |
...
📄 Full paper: [Ecuador_Growth_Poverty_Inequality_Analysis.docx](papers/Ecuador_Growth_Poverty_Inequality_Analysis.docx)
...
|:---:|:---:|
| ![GDP](charts/project2/gdp_growth_annual.png) | ![National Poverty](charts/project2/poverty_rates_national.png) |

| Urban Poverty Rates | Rural Poverty Rates |
|:---:|:---:|
| ![Urban](charts/project2/poverty_rates_urban_rural.png) | ![Rural](charts/project2/poverty_rates_rural.png) |

| Inflation Stabilisation Post-Dollarisation | Unemployment Rate |
|:---:|:---:|
| ![Inflation](charts/project2/inflation_consumer_prices.png) | ![Unemployment](charts/project2/unemployment_rate.png) |
...
📄 Full report: [Ecuador_Dollarisation_Indigenous_Inequality_Report.docx](papers/Ecuador_Dollarisation_Indigenous_Inequality_Report.docx)
...
├── README.md
├── papers/
│   ├── Ecuador_Growth_Poverty_Inequality_Analysis.docx
│   └── Ecuador_Dollarisation_Indigenous_Inequality_Report.docx
└── charts/
    ├── project1/
    │   ├── gini_coefficient_timeseries.png
    │   ├── poverty_headcount_ratio.png
    │   ├── gdp_growth_annual.png
    │   ├── inflation_rate_comparison.png
    │   ├── gdp_per_capita.png
    │   └── income_distribution.png
    └── project2/
        ├── exchange_rate_crisis_diagram.png
        ├── gdp_growth_annual.png
        ├── inflation_consumer_prices.png
        ├── poverty_rates_national.png
        ├── poverty_rates_urban_rural.png
        ├── poverty_rates_rural.png
